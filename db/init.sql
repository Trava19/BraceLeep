...
--
-- Host: localhost
-- Generation Time: May 12, 2026 at 08:07 PM
-- Server version: 10.4.32-MariaDB
-- PHP Version: 8.0.30-- phpMyAdmin SQL Dump
-- version 5.2.1
-- https://www.phpmyadmin.net/
--
-- Host: localhost
...
--
-- Table structure for table `dati_braccialetto`
--

CREATE TABLE `dati_braccialetto` (
  `id` int(11) NOT NULL,
  `b` int(11) NOT NULL,
  `r` int(11) NOT NULL,
  `data_esatta` datetime NOT NULL,
  `idUtente_datoBraccialetto` int(11) NOT NULL
...
INSERT INTO `dati_sonno` (`id`, `id_utente`, `tst`, `waso`, `se_efficienza`, `se_tempo_dormita`, `nRisvegli`, `daw`, `mi`, `ai`, `giorno_dormita`) VALUES
(1, 5, 123, 12, 55.30, 1, 1, 1, 1.10, 1, '0000-00-00');
...
--
-- Indexes for table `dati_braccialetto`
--
ALTER TABLE `dati_braccialetto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_id` (`idUtente_datoBraccialetto`);
...
--
-- AUTO_INCREMENT for table `dati_braccialetto`
--
ALTER TABLE `dati_braccialetto`
...
--
-- Constraints for table `dati_braccialetto`
--
ALTER TABLE `dati_braccialetto`
  ADD CONSTRAINT `fk_id` FOREIGN KEY (`idUtente_datoBraccialetto`) REFERENCES `utenti` (`id`);
